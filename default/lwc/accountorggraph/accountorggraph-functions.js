...
export default {
    ...
    viewObjectDetail(viewerType, typeHint, objectId, accountId) {
    ...
    menuClicked(event) {
        ...
        console.log('event.currentTarget.dataset.action:',event.currentTarget.dataset.action);
        console.log('event.currentTarget.dataset.category:',event.currentTarget.dataset.category);
        console.log('event.currentTarget.dataset.contact contactId:',event.currentTarget.dataset.contact);
        ...
        switch (action) {
            ...
            case 'account':
                ...
                this.viewObjectDetail('standard', 'account', dataId);
                break;
            case 'member':
    ...
    deleteSelection() {
        console.log('delete Section: ',this._canEditGraph);
        if (!this._canEditGraph) {
            return;
        }
