...
import orgGraphFunctions from './accountorggraph-functions.js';
...
import LABEL_CREATE_NEW_ACCOUNT from '@salesforce/label/c.Create_New_Account';
...
import LABEL_VIEW_ACCOUNT_DETAILS from '@salesforce/label/c.View_Account_Details';
...
export default class Accounorggraph extends LightningElement {
    constructor() {
        super();
    ...
    labels = {
        ...
        clear: LABEL_CLEAR,
        contactDetail: LABEL_VIEW_ACCOUNT_DETAILS,
        ...
        newContact: LABEL_CREATE_NEW_ACCOUNT,
    ...
    async connectedCallback() {
        ...
        function showContextMenu(obj) {
            ...
            if (canViewContact && self.rmOrgSettings?.pqcrush__Enable_Contact_Context_Menu__c) {
                newMenuActions.push({ name: 'account', label: self.labels.contactDetail, objectId: objectId });
            }
            ...
            if (canRemove) {
                ...
                console.log('newMenuActions>>>> '+JSON.stringify(newMenuActions));
            }
        ...
        this.orgDiagram.commandHandler.deleteSelection = function () {
            ...
            parts.each((part) => {
                ...
                if (part instanceof go.Node && !(part instanceof go.Group)) {
                    ...
                    console.log('part:',JSON.stringify(part.data));
                    console.log('part.data.objectId:',part.data.Id);
                    console.log('part.data.category:',part.data.category);
                    console.log('part.data.secondaryKey:',part.data.secondaryKey);
                    switch (part.data.category) {
                        
                        case 'keystakeholder':
                            accountIdsToRemove.push(part.data.Id);
                            mapMemberIdsToDelete.push(part.data.secondaryKey);
                            console.log('mapMemberIdsToDelete:',mapMemberIdsToDelete);
                            const fields = {};
                            fields[ID_FIELD.fieldApiName] = part.data.key;
                            fields[PARENTID_FIELD.fieldApiName] ='';
            ...
            self.removeGraphMember(accountIdsToRemove);
