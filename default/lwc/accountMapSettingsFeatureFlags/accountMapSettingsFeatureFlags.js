...
import Account_Map_Features from '@salesforce/label/c.Account_Map_Features';
...
import CreateNewAccount from '@salesforce/label/c.Create_New_Account';
    ...
    async loadSettings() {
        ...
        await getRMOrgSettingForType({ type: this._settingType })
            .then((result) => {
                ...
                this.createNewContact = result?.pqcrush__Create_New_Account__c;
